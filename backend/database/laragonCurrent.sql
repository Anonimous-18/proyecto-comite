...
-- Volcando datos para la tabla proyecto_comite.aprendices_implicados: ~18 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `articulos` (
  `art_id` int NOT NULL,
  `art_titulo` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `art_descripcion` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `cap_id` int NOT NULL,
  PRIMARY KEY (`art_id`),
  KEY `cap_id` (`cap_id`),
...
CREATE TABLE IF NOT EXISTS `capitulos` (
  `cap_id` int NOT NULL,
  `cap_titulo` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`cap_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `comites` (
  ...
  `tipo_falta` enum('disciplinaria','academica') COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion_solicitud` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `carpeta_anexos` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `acta` text COLLATE utf8mb4_general_ci,
  `estado` enum('espera','rechazado','aceptado','ejecucion') COLLATE utf8mb4_general_ci DEFAULT 'espera',
  `recomendacion` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `anexar_plan_mejoramiento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `resultado_plan_mejoramiento` enum('D','A') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP,
  `articulos` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
-- Volcando datos para la tabla proyecto_comite.comites: ~18 rows (aproximadamente)
INSERT INTO `comites` (`id`, `instructor_fk`, `tipo_falta`, `descripcion_solicitud`, `carpeta_anexos`, `acta`, `estado`, `recomendacion`, `anexar_plan_mejoramiento`, `resultado_plan_mejoramiento`, `createdAt`, `updatedAt`, `articulos`) VALUES
	(4, 491, 'disciplinaria', 'Se requiere una revisión disciplinaria del caso.', 'https://drive.google.com/...', 'Este es el contenido del acta...', 'rechazado', 'Se recomienda tomar medidas disciplinarias.', 'https://drive.google.com/...', 'A', '2023-10-04 23:15:15', '2023-10-05 00:34:59', ''),
	(5, 491, 'disciplinaria', 'Se requiere una revisión disciplinaria del caso.', 'https://drive.google.com/...', 'Este es el contenido del acta...', 'aceptado', 'Se recomienda tomar medidas disciplinarias.', 'https://drive.google.com/...', 'A', '2023-10-04 23:22:51', '2023-10-04 23:22:51', ''),
	(7, 491, 'disciplinaria', 'Se requiere una revisión disciplinaria del caso.', 'https://drive.google.com/...', 'Este es el contenido del acta...', 'espera', 'Se recomienda tomar medidas disciplinarias.', 'https://drive.google.com/...', 'A', '2023-10-04 23:22:53', '2023-10-04 23:22:53', ''),
	(8, 491, 'disciplinaria', 'Se requiere una revisión disciplinaria del caso.', 'https://drive.google.com/...', 'Este es el contenido del acta...', 'ejecucion', 'Se recomienda tomar medidas disciplinarias.', 'https://drive.google.com/...', 'A', '2023-10-04 23:22:55', '2023-10-04 23:22:55', ''),
	(20, 491, 'academica', 'Ejemplo comite', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-08 17:50:57', '2023-10-08 17:50:57', '14'),
	(21, 491, 'disciplinaria', 'fdhidjhsdfakhdfjk', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-27 11:50:10', '2023-10-27 11:50:10', '19,21'),
	(22, 491, 'academica', 'sdfsfsadfa', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-27 11:50:23', '2023-10-27 11:50:23', '21'),
	(23, 491, 'academica', 'afsfsadfasdf', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 15:51:57', '2023-10-30 15:51:57', '2,52'),
	(24, 491, 'academica', 'dsfasdfafsaf', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 15:54:39', '2023-10-30 15:54:39', '4'),
	(25, 491, 'academica', 'sfdfdsafasdf', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 15:57:53', '2023-10-30 15:57:53', '24'),
	(26, 491, 'academica', 'sdfsdafasfsdfsa', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:00:39', '2023-10-30 16:00:39', '2'),
	(27, 491, 'academica', 'sdgfasasgasdgasdg', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:00:51', '2023-10-30 16:00:51', '3'),
	(28, 491, 'academica', 'dfghdfghdfghgdhggf', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:01:03', '2023-10-30 16:01:03', '14'),
	(29, 491, 'disciplinaria', 'afsfasdfasdfasdfsadf', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:01:25', '2023-10-30 16:01:25', '5,4,8'),
	(30, 491, 'academica', 'fsadfsadfsadfdsa', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:01:41', '2023-10-30 16:01:41', '19,7'),
	(31, 491, 'disciplinaria', 'sdfasdfasdfasdfsa', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:01:55', '2023-10-30 16:01:55', '4'),
	(32, 491, 'academica', 'sgfdgsdfgdsfgdsfgdsf', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:02:13', '2023-10-30 16:02:13', ''),
	(33, 491, 'academica', 'sdadsafasfasdfdsfasd', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:02:33', '2023-10-30 16:02:33', '69,67'),
	(34, 491, 'disciplinaria', 'afdsfasdfasdfdasfdsafdsfasdf', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 16:02:49', '2023-10-30 16:02:49', '5,12'),
	(35, 491, 'academica', 'sdfasfdddsafasd', NULL, NULL, 'espera', NULL, NULL, NULL, '2023-10-30 17:02:44', '2023-10-30 17:02:44', '8,9,21');
...
CREATE TABLE IF NOT EXISTS `fichas` (
  ...
  `modalidad` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `jornada` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `programa` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `paragrafos` (
  ...
  `par_descripcion` varchar(900) COLLATE utf8mb4_general_ci NOT NULL,
  `art_id` int NOT NULL,
  PRIMARY KEY (`par_id`),
  KEY `art_id` (`art_id`),
...
-- Volcando datos para la tabla proyecto_comite.sequelizemeta: ~14 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `dependencia` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `creado` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
