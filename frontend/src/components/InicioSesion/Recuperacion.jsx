      ...
      <section className="bg-gray-50 ">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-full bg-gradient-to-r bg-blue-800  rounded-lg  dark:border md:mt-0 sm:max-w-md xl:p-0 shadow-xl  ">
            ...
            <h3 class=" text-center mt-4 mb-4 text-sm font-extrabold text-white md:text-5xl lg:text-3xl"> Recuperacion de contraseña 
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-sky-500 from-sky-400"> SE-JustApp</span></h3>
