...
const Prueba = () => {
  ...
  return (
    <div>
      ...
      <button className="cursor-pointer flex items-center justify-center w-55 m-6 sm:w-64 h-12 sm:h-16 px-4 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 focus:bg-blue-600 text-2xl" onClick={()=>{ forceRender();enviarUsuarios(); }} >Enviar</button>
    </div>
