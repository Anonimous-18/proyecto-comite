              ...
              <form onSubmit={formik.handleSubmit}>
                <div className="bg-gray-100 rounded-lg shadow">
                  ...
                  <div className="px-5 pb-5">
                    ...
                    <small className="mt-3 inline-block text-xs font-bold">Fecha de Inicio Lectiva:</small>
                    <Field
                      type="date"
                      name="inicioLectiva"
                    ...
                    <small className="mt-3 inline-block text-xs font-bold">Fecha Fin Lectiva:</small>
                    <Field
                      type="date"
                      name="finLectiva"
                    ...
                    <small className="mt-3 inline-block text-xs font-bold">Fecha de Inicio Productiva:</small>
                    <Field
                      type="date"
                    ...
                    <small className="mt-3 inline-block text-xs font-bold">Fecha Fin Productiva:</small>
                    <Field
                      type="date"
                      name="finProductiva"
                      placeholder="Fecha Fin"
                  ...
                  <div className="flex flex-row-reverse p-3">
                    <div className="flex-initial pl-3">
                      ...
                      >
                        ...
                        <span className="pl-2 mx-1">Registrar Ficha</span>
                      </button>
                    </div>
