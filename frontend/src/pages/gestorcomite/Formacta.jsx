          ...
          <div className="mt-5 bg-white rounded-lg shadow">
            ...
            <div className="flex">
              <div className="flex-1 py-5 pl-5 overflow-hidden">
                ...
                <input
                  className="text-black placeholder-gray-600 px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400 m-auto ml-1 w-[60px] "
                  defaultValue={"No"}
                />
                <br />
                <textarea
                ...
                {divs.map((div, index) =>  (
                  <div key={div} className="flex flex-col ">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 m-5">
                      <select className="p-3 w-60 sm:w-96" onChange={handleSelect}>
                    ...
                    <input type="text" className="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400" placeholder={casoOption?'Nombre aprendiz':"Nombre"} />
                    <textarea
                      name=""
                      id=""
                      rows="4"
                      className="text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400" placeholder="Opinion o descripcion de caso"
                    ></textarea>
                  </div>
                ))}
              </div>
