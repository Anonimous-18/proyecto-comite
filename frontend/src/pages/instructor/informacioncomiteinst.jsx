...
export const Informacioncomiteinst = () => {
  ...
  useEffect(() => {
    ...
    const token = contextApi.decode(sessionStorage.getItem("Datos"));
  ...
  return (
    <DefaultLayout>
      <div className="h-full w-full flex flex-col items-center justify- place-content-evenly rounded-2xl">
        <h1 className="flex flex-col items-center p-2 text-blue-800 mt-5 text-xl">
          INFORMACIÓN DEL COMITE
        </h1>
        <div className=" flex flex-col 2xl:flex-row xl:flex-row lg:flex-row md:flex-row justify-center items-center w-auto h-full space-x-2 border-2 mt-5">
          {comite && comite !== null ? (
            <>
              <div className="p-5 h-full">
                <Link
                  ...
                  className="ml-3 mb-5 relative inline-flex items-center rounded-md border border-transparent bg-blue-600 border-blue-900 px-10 py-2 text-lg font-semibold text-white shadow-xl transition duration-300 ease-in-out hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2"
                >
                  Volver
                </Link>
                ...
                <div>
                  ...
                  {aprendicesImplicados && aprendicesImplicados.length !== 0 ? (
                    aprendicesImplicados.map((aprendiz) => (
                      <p
                        key={aprendiz.id}
                        className="bg-gray-50 border border-gray-300 mb-2 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                      >
              ...
              <div className="p-5">
                ...
                <div className="w-full p-2">
                  ...
                  <button
                    ...
                    onClick={
                      comite && comite.evidencia
                        ? () => handleArchivo(comite.evidencia)
                        : null
                    }
